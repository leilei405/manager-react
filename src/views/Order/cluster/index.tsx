...
// import { getOrderClusterData } from '@/api'

// const OrderCluster = () => {
//   const [cityId, setCityId] = useState(10001)

//   const getCityData = async () => {
//     const data = await getOrderClusterData(cityId)
//     setTimeout(() => {
//       renderMap(data)
//     })
//   }
...
//   return (
//     <div>
//       <Select value={cityId} style={{ width: 100, marginBottom: 20 }} onChange={handleChange}>
...
//       </Select>
//       <div id='orderCluster' style={{ height: 'calc(100vh - 280px)' }}></div>
//     </div>
//   )
// }
